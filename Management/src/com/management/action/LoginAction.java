...
public class LoginAction extends ActionSupport implements ModelDriven<Object>, ProjectConstants {
	...
	public String login() {
		...
		//put account and userNumber
		try {
			User us = userBO.getByNamePassword(user.getUsername(), user.getPassword());
			session.put("account", us.getAccount());
			session.put("userNumber", us.getUserNumber());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
